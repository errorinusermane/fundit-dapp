...
export interface FunditTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FunditToken extends BaseContract {
  connect(runner?: ContractRunner | null): FunditToken;
  waitForDeployment(): Promise<this>;

  interface: FunditTokenInterface;
